...
def test_get_device_interface_count(runner, cli, auth_options):
    result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-device-interface-count'])
...
def test_get_device_list(runner, cli, auth_options):
    result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-device-list'])
    assert not result.exception
    if result.output.strip():
        obj = loads(result.output)
...
def test_sync_devices_using_forcesync(runner, cli, auth_options):
    device_list = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-device-list'])
    device_list = mydict_data_factory('', loads(device_list.output))
    result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'sync-devices-using-forcesync',
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-polling-interval-for-all-devices'])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-device-count'])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-device-interface-vlans', '''--id=devices_filtered[0].id'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-device-interfaces-by-specified-range', '''--device_id=get_device_list(api).response[0].id''', '''--records_to_return=1''', '''--start_index=3'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-device-config-by-id', '''--network_device_id=get_device_list(api).response[0].id'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-device-config-count'])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-all-interfaces', '''--limit=500''', '''--offset=1'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-interface-details', '''--device_id=get_device_list(api).response[0].id''', '''--name=get_device_interface_vlans(api).response[0].interfaceName'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-polling-interval-by-id', '''--id=get_device_list(api).response[0].id'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-module-count', '''--device_id=get_device_list(api).response[0].id'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-interface-info-by-id', '''--device_id=get_device_list(api).response[0].id'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-device-summary', '''--id=get_device_list(api).response[0].id'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-functional-capability-for-devices', '''--device_id=get_device_list(api).response[0].id'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-device-interface-count-by-id', '''--device_id=get_device_list(api).response[0].id'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-modules', '''--device_id=get_device_list(api).response[0].id'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-wireless-lan-controller-details-by-id', '''--id=get_device_list(api).response[0].id'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-organization-list-for-meraki', '''--id=filtered_device_list[0].id'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-ospf-interfaces'])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-functional-capability-by-id', '''--id=functional_capability.id'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-isis-interfaces'])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-device-config-for-all-devices'])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-interface-by-ip', '''--ip_address=filtered_interfaces[0].ipv4Address'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-network-device-by-ip', '''--ip_address=get_device_list(api).response[0].managementIpAddress'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-device-by-id', '''--id=get_device_list(api).response[0].id'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'sync-devices'])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-interface-by-id', '''--id=get_all_interfaces(api).response[0].id'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-device-by-serial-number', '''--serial_number=filtered_device_list[0].serialNumber'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-network-device-by-pagination-range', '''--records_to_return=4''', '''--start_index=1'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'retrieves-all-network-devices', '''--hostname=get_device_list(api).response[0].hostname'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-device-detail', '''--identifier="macAddress"''', '''--search_by=get_device_list(api).response[0].macAddress'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-module-info-by-id', '''--id=get_device_list(api).response[0].lineCardId.split(',')[0]'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'add-device', '''--ipAddress=[new_ipAddress]''', '''--payload={
#             "cliTransport": "ssh",
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'get-device-by-id-last', '''--id=get_device_list(api).response[-1].id'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
#         assert json_schema_validate('jsd_8fa8eb404a4a8d96_v1_2_10').validate(obj) is None
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'update-device-role', '''--id=get_device_list(api).response[0].id''', '''--role=get_device_list(api).response[0].role''', '''--roleSource=get_device_list(api).response[0].roleSource'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'register-device-for-wsa', '''--macaddress=get_device_list(api).response[0].macAddress''', '''--serial_number=get_device_list(api).response[0].serialNumber'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'export-device-list', '''--deviceUuids=[get_device_list(api).response[0].id]''', '''--id=get_device_list(api).response[0].id''', '''--operationEnum='CREDENTIALDETAILS''''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
...
#     result = runner.invoke(cli, ['v1-2-10', *auth_options, 'devices', 'delete-device-by-id', '''--id=filtered_device_list[0].id'''])
#     assert not result.exception
#     if result.output.strip():
#         obj = loads(result.output)
